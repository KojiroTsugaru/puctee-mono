...
class User(Base):
    ...
    sent_invites = relationship("FriendInvite", back_populates="sender", foreign_keys="FriendInvite.sender_id", cascade="all, delete-orphan")
    received_invites = relationship("FriendInvite", back_populates="receiver", foreign_keys="FriendInvite.receiver_id", cascade="all, delete-orphan")
    ...
    plan_invites = relationship("PlanInvite", back_populates="user", cascade="all, delete-orphan")
    trust_stats = relationship("UserTrustStats", back_populates="user", cascade="all, delete-orphan")
...
class PenaltyApprovalRequest(Base):
    ...
    penalty_user_id = Column(Integer, ForeignKey('users.id', ondelete='CASCADE'), nullable=False)  # User requesting approval
    ...
    approver_user_id = Column(Integer, ForeignKey('users.id', ondelete='SET NULL'), nullable=True)  # User who approved/declined
